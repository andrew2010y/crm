...
<html>
               	...
               	<div class="box report-box">
               		<div class="">
               			<div class="box-header">
                            <h3 class="box-title">会员发展统计</h3>
                            <div class="box-tools pull-right">
                                <div class="btn-group" id="realtime" data-toggle="btn-toggle">
                                    <button type="button" class="btn btn-info ch-chart active" data-toggle="on" data-value="30" data-type="month">30天</button>
                                    <button type="button" class="btn btn-info ch-chart" data-toggle="off" data-value="7" data-type="week">7天</button>
                                    <button type="button" class="btn btn-info ch-chart" data-toggle="off" data-value="2" data-type="hour">48小时</button>
                                </div>
                            </div>
                        </div>
                        <div class="box-body chart-responsive">
                            <div class="chart" id="barUserChart" style="height: 500px;"></div>
                        </div>
                        <div class="box-body chart-responsive">
	...
	<script type="text/javascript" src="${ctx}/js/apps/report/customer-report.js?v=${v}" ></script>
</html>