    ...
    <%
    	...
    	for(int i=0;i<arr.length;i++){
			...
			String savePathNew = session.getAttribute("filePathImg").toString();
			String imgDomain1 = session.getAttribute("imgDomain11").toString();
			String rr1 = session.getAttribute("relativefilepath1").toString();
    		//System.out.println("DDDDDDDDSS:"+savePathNew);
    		//System.out.println("DDDDDDDDSS:"+imgDomain1);
    		//System.out.println("DDDDDDDDSS:"+rr1);
    		
    		File savetoFile = new File(savePathNew +"/"+ saveName);
    		
    		
    		
    		//System.out.println("DDDDDDDDSS1111111111:"+savePath);
    		//System.out.println("DDDDDDDDSS1111111111:"+filePath);
    		
    		outSrc[i]=imgDomain1 + rr1.replaceAll("\\\\", "/") + saveName;
    		
    		//System.out.println("aaa:"+imgDomain1 + rr1 + saveName);
    		//System.out.println("a1:"+saveName);
    		
    		
    		//System.out.println("22222222222222:"+outSrc[i]);
    		try {
