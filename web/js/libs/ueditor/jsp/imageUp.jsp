    <%@ page language="java" contentType="text/html; charset=utf-8"
        ...
        <%@ page import="com.shinesky.otoxplf.product.action.Uploader" %>
...
//String s1 = request.getSession().getAttribute("relativePath").toString();
//s1 = s1.substring(0,s1.lastIndexOf(File.separator));

//s1 = s1.replaceAll("\\\\", "/");
//System.out.println("S!!!!!!!!!!!!!!!!!!!!!!!!:"+s1);
up.setSavePath("");
//System.out.println("zzz1zzzzz:"+s1);
String[] fileType = {".gif" , ".png" , ".jpg" , ".jpeg" , ".bmp"};
up.setAllowFiles(fileType);
up.setMaxSize(500 * 1024); //单位KB
up.upload();
//System.out.println("DKK:"+up.getUrl());
