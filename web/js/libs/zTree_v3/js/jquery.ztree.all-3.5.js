...
(function($){
	...
	_view = {
		...
		editNode: function(setting, node) {
			...
			var maxLength = setting.edit.maxLength;
			var nameKey = setting.data.key.name;
			node.editNameFlag = true;
			view.removeTreeDom(setting, node);
			view.cancelCurEditNode(setting);
			view.selectNode(setting, node, false);
			$$(node, consts.id.SPAN, setting).html("<input type=text class='rename' maxlength='"+ maxLength +"' id='" + node.tId + consts.id.INPUT + "' treeNode" + consts.id.INPUT + " >");
