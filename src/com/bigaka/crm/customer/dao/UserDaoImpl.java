...
public class UserDaoImpl implements UserDao{
	...
	public User getByUserNameAndPassword(String userName, String password) {
		...
		sql.append(", parent_store_id parentStoreId,store_id storeId ")
		.append(", username,open_id openId,state")
		.append(" from user c")
		.append(" where c.username = ?")
		.append(" and c.password = ?");
		...
		return handler.getForObject(sql.toString(), User.class, paramList.toArray());
	}
